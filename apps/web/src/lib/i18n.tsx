...
const ro = {
  ...
  'contact.sizePrefill': 'Mă interesează varianta de {size} cm lățime.',
  'piece.size': 'Dimensiune',
  'piece.sizeOptions': 'dimensiuni',
  'piece.sizeUnit': 'cm lățime',
  'piece.sizeNote':
    'Lățimea saltelei, în centimetri. Fabrica fiind a noastră, se pot croi și alte dimensiuni — cereți-ne și vă răspundem în aceeași zi.',
...
const en: Record<keyof typeof ro, string> = {
  ...
  'contact.sizePrefill': 'I am interested in the {size} cm width.',
  'piece.size': 'Size',
  'piece.sizeOptions': 'sizes',
  'piece.sizeUnit': 'cm wide',
  'piece.sizeNote':
    'Mattress width, in centimetres. The workshop is ours, so other sizes can be cut — ask and we answer the same day.',
